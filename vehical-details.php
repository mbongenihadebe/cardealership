...
<title>Car Sales Dealership  | Vehicle Details</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>R<?php echo htmlentities($result->PricePerDay);?> </p>(neg)
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-envelope" aria-hidden="true"></i>Bid Now</h5>
          </div>
          <form method="post">
            ...
            <div class="form-group">
              <input type="text" class="form-control" name="todate" placeholder="Make Offer" required>
            </div>
            <div class="form-group">
              <textarea rows="4" class="form-control" name="message" placeholder="Admin Fee = R1500.00" required></textarea>
            </div>
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login For Bid</a>
